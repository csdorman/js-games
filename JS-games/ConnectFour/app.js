document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        // this array shows all possible winning combinations
        const winningArrays = [
        ...
        // take 4 values in each winningArray and plug them into the grid squares
        for(let y = 0; y < winningArrays.length; y++) {
            ...
            if(square1.classList.contains('player-one') && square2.classList.contains('player-one') && square3.classList.contains('player-one') && square4.classList.contains('player-one')) {
                //if yes, player one is the winner
                ...
                //if yes, player two is the winner
                result.innerHTML = 'Player Two Wins!';
            }
        }
    }
    //add event listener to each square that will trigger checkBoard function after each move
